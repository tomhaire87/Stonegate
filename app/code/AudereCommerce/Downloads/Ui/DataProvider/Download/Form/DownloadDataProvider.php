...
namespace AudereCommerce\Downloads\Ui\DataProvider\Download\Form;

use AudereCommerce\Downloads\Model\ResourceModel\Download\CollectionFactory;
use Magento\Ui\DataProvider\AbstractDataProvider;
use Magento\Ui\DataProvider\Modifier\PoolInterface;

class DownloadDataProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        foreach ($this->getCollection() as $item) {
            $this->data[$item->getId()]['download'] = $item->getData();
        }
