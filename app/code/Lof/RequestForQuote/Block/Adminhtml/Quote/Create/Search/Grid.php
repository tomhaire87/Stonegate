 ...
 */
namespace Lof\RequestForQuote\Block\Adminhtml\Quote\Create\Search;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Lof\RequestForQuote\Helper\Data $dataHelper
     * @param array $data
     */
    ...
    {
        $enable_addtoquote_nonsale = $this->_dataHelper->getConfig('general/enable_addtoquote_nonsale');
    ...
    {
        return $this->_sessionQuote->getRfqQuote();
    }
    ...
    public function getGridUrl()
    {
        return $this->getUrl(
            ...
            ['block' => 'search_grid', 'collapse' => null]
        );
    }
}
