 ...
 */
namespace Lof\RequestForQuote\Controller\Wishlist;
...
class ToQuote extends \Magento\Wishlist\Controller\AbstractIndex
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addException($e, __('We can\'t add the item to the quote right now.'));
        }
